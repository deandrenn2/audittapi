...
public class AppDbContextFactory : IDesignTimeDbContextFactory<AppDbContext>
{
    ...
    {
        // Asumiendo que el appsettings.json está en el proyecto Auditt.Application.API
        var path = Path.Combine(Directory.GetParent(Directory.GetCurrentDirectory())?.FullName ?? "", "Auditt.Api");
