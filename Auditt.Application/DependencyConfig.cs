...
public static class DependencyConfig
{
    ...
    public static IServiceCollection ConfigureServices(this IServiceCollection services)
    {
        ...
        services.AddCors(options =>
        {
            ...
            {
                builder.WithOrigins("http://localhost:5173", "https://localhost:5173", "http://localhost:5000", "http://localhost:7045", "http://audittweb.host.imagyapp.net", "https://audittweb.host.imagyapp.net", "https://auditoriamedica.net", "http://auditoriamedica.net", "https://app.auditoriamedica.net", "http://app.auditoriamedica.net")  // Permite cualquier origen
                .AllowCredentials()
