                    ...
                    <div className="bg-white px-2 py-2 border border-gray-200">
                        {guides?.map((guide) => (
                            <div className="grid grid-cols-4" key={guide.id}>
                                ...
                                <div className="grid grid-cols-3 gap-3 text-sm bg-white px-2 py-2 border border-gray-300 mr-2 mb-2">{questions?.filter(q => q.idGuide === guide.id).length ?? 0}</div>
                                <div className="flex justify-center">
                                    <div onClick={() => handleGuideDetail(guide)}>
                                        <ButtonPlay />
                                    </div>
                                    <Link to={`/questions/${guide.id}`}>
